...
import (
	context "context"
	domain "golang-restful-api/model/domain"
	reflect "reflect"
...
func (m *MockCategoryRepository) Delete(ctx context.Context, category domain.Category) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "Delete", ctx, category)
}
...
func (m *MockCategoryRepository) Save(ctx context.Context, category domain.Category) domain.Category {
	m.ctrl.T.Helper()
...
func (m *MockCategoryRepository) Update(ctx context.Context, category domain.Category) domain.Category {
	m.ctrl.T.Helper()
